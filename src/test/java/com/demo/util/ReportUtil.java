...
public class ReportUtil {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//demo//config//config.properties");
        Properties CONFIG= new Properties();
        CONFIG.load(fs);
        String environment=CONFIG.getProperty("environment");
        String release=CONFIG.getProperty("release");
        Xls_Reader suiteXLS = new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//demo//xls//Suite.xlsx");
...
System.out.println(indexHtmlPath);
        ...
        try{
            ...
            out.write("<html><HEAD> <TITLE>Automation Test Results</TITLE></HEAD><body><h4 align=center><FONT COLOR=660066 FACE=AriaL SIZE=6><b><u> Automation Test Results Demo</u></b></h4><table  border=1 cellspacing=1 cellpadding=1 ><tr><h4> <FONT COLOR=660000 FACE=Arial SIZE=4.5> <u>Test Details :</u></h4><td width=150 align=left bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE=Arial SIZE=2.75><b>Run Date</b></td><td width=150 align=left><FONT COLOR=#153E7E FACE=Arial SIZE=2.75><b>");
            ...
            out.write(release);
            out.write("</b></td></tr><tr><td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Login User</b></td><td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>");
            out.write("Siva");
            ...
            for(int currentSuiteID =2;currentSuiteID<= totalTestSuites;currentSuiteID++){
                ...
                current_suite_xls=new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//demo//xls//"+currentTestSuite+".xlsx");
                ...
                if(suiteXLS.getCellData(Constants.TEST_SUITE_SHEET, com.demo.test.Constants.RUNMODE,currentSuiteID).equalsIgnoreCase(Constants.RUNMODE_YES))
